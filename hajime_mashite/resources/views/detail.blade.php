...
<body>
    <div id="main">
            ...
            <ul class="nav nav-pills">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#item-1">これまでの私</a></li>
                        ...
                        <li><a class="dropdown-item" href="#item-2">これからの私</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
        ...
        <div class="container">
            ...
            <div id="item-1-1" class="row p-3">
                <div class="col-md-4   text-center"><img src="img/me.jpg" class="w-50 h-auto"></div>
                <div class="col-md-8">
                    <h3>中学生</h3>
                    <p>
